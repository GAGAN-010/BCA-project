...
<head>
    <meta charset="utf-8">
    <title>Fresh-chicken:Feedback Form</title>
...
<body>
                ...
                <div class="navbar-nav ms-auto p-4 p-lg-0">
				   ...
				   <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu m-0">
                            <a href="customer_sign.php" class="dropdown-item">Signup</a>
    ...
    <div class="container-fluid page-header wow fadeIn" data-wow-delay="0.1s">
        <div class="container">
            <h1 class="display-3 mb-3 animated slideInDown">Vendor Login</h1>
    ...
    <div class="container-xxl py-6">
        <div class="container">
            <div class="section-header text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <h1 class="display-5 mb-3">Vendor Login</h1>
                <p>This is Login form only shop keeper can access it.
            </div>
            <div class="row g-5 justify-content-center">
                <div class="col-lg-5 col-md-12 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="bg-primary text-white d-flex flex-column justify-content-center h-100 p-5">
                        <h5 class="text-white">Call Us</h5>
                        <p class="mb-5"><i class="fa fa-phone-alt me-3"></i>+6361297370</p>
                        <h5 class="text-white">Email Us</h5>
                        <p class="mb-5"><i class="fa fa-envelope me-3"></i>freshchicken.com</p>
                        <h5 class="text-white">Office Address</h5>
                        <p class="mb-5"><i class="fa fa-map-marker-alt me-3"></i>Karwar, KARANATAK, INDIA</p>
                ...
                <div class="col-lg-7 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
                    <form action="vlogin_check.php" method="POST">
                         ...
                         <br><br>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    ...
                                    <label for="name">Enter User Password</label>
                                </div>
                            </div>
							
					
                            <div class="col-12">
                                <button class="btn btn-primary rounded-pill py-3 px-5" name="login" value="Login">Login</button>
                            </div>
                        </div>
                    </form>
                </div>
