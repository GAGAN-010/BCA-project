	...
	<style>
	   table {
        ...
        th, td {
            padding: 12px 20px;
            text-align: center;
            border-bottom: 1px solid #d9f2dd;
        }
        ...
        .primary-btn {
    background-color:rgba(1, 178, 33, 0.73);           /* Bootstrap primary blue */
    color: #fff;
    padding: 10px 30px;
    border: none;
    border-radius: 50px;
...
.primary-btn:hover {
    background-color:rgb(0, 255, 55);           /* Slightly darker on hover */
    box-shadow: 0 6px 16px rgba(0, 124, 21, 0.3);
    transform: translateY(-2px);
}

.primary-btn:active {
    transform: translateY(1px);
    box-shadow: 0 2px 8px rgba(55, 255, 0, 0.2);
}
    ...
    <div class="container-xxl py-6">
        <div class="container">
            <div class="section-header text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <h1 class="display-5 mb-3">CART</h1>
                <p>your items added to cart.
...
?> 
         ...
         <caption>Net Total:: <?php echo $nettotal; ?></caption>
    </table>
            </div>
     <div class="row g-5 justify-content-center">
    <div class="col-auto text-center">
        <a href="viewallchicken.php">
            Back to Cart
        </a>
        <br>
         <form action="buynow.php" method="POST" style="display:inline;">
                            <input type="hidden" name="food_id" value="' . htmlspecialchars($row['cid'], ENT_QUOTES, 'UTF-8') . '">
                            <button type="submit" class="primary-btn">Claim</button>
                        </form>
    </div>
</div>
  </table>  
