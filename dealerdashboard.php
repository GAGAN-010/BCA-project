...
<!-- Admin Order Table Start -->
<div class="container-xxl py-5" style="margin-top: 120px;">
  <div class="container">
    <div class="card shadow-lg">
      <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
        <h5 class="mb-0"><i class="fas fa-box-open me-2"></i>Customer Orders</h5>
        <span class="badge bg-light text-primary">Admin View</span>
      </div>
              ...
              if ($result->num_rows > 0) {
                  while ($row = $result->fetch_assoc()) {
                      echo '<tr>
                              ...
                              <td>' . htmlspecialchars($row["chkqty"]) . ' Kg</td>
                              <td>' . htmlspecialchars($row["email"]) . '</td>
                              <td>' . htmlspecialchars($row["order_date"]) . '</td>
                              <td>
                                <a href="allactions.php?usr=' . urlencode($row["cid"]) . '" class="btn btn-sm btn-danger" onclick="return confirm(\'Are you sure you want to delete this order?\');">
                  ...
                  echo '<tr><td colspan="6" class="text-muted">No orders found.</td></tr>';
              }
            ?>
          </tbody>
        </table>
