...
<body>
    ...
    <div class="container-fluid page-header wow fadeIn" data-wow-delay="0.1s">
        <div class="container">
            <h1 class="display-3 mb-3 animated slideInDown">vendor Signup</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a class="text-body" href="#">Home</a></li>
                    <li class="breadcrumb-item text-dark active" aria-current="page">vendor Registration</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container-xxl py-6">
        <div class="container">
            <div class="section-header text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <h1 class="display-5 mb-3">Vendor Signup</h1>
            ...
            <div class="row g-5 justify-content-center">
                ...
                <div class="col-lg-7 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <form name="registerForm" action="vlogin.php" method="POST" onsubmit="return validatePassword();">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="email" class="form-control" name="Shop_email" placeholder="Your Email">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
								  <input type="text" name="Shop_name" class="form-control" id="name" required pattern="[A-Za-z\s]+" title="Only letters and spaces allowed" placeholder="Enter your name" />
							  ...
							  <div class="col-md-12">
                                <div class="form-floating">
								  <input type="tel" name="Shop_phone" id="phone" class="form-control"required pattern="[0-9]{10}" maxlength="10" title="Enter 10-digit phone number" placeholder="e.g. 9876543210" />
                                    <label for="email">Shop Phone</label>
                                </div>
                            </div>
							   ...
							   <div class="col-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="Shop_address" placeholder="Subject">
                                    <label for="subject">Shop Address</label>
                                </div>
                            </div>
 ...
 <label>Re-enter Password:</label>
                            ...
                            <div class="col-12">
                                <button class="btn btn-primary rounded-pill py-3 px-5" type="submit">Register Shop</button>
                            </div>
                        </div>
                    </form>
                </div>
